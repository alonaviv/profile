...
urlpatterns = [
    ...
    path('add_students_to_class/<int:class_id>/<int:house_id>', views.add_students_to_class,
         name='add_students_to_class'),
    path('add_students_to_class/<int:class_id>', views.add_students_to_class, name='add_students_to_class'),
    path('delete_student_from_class/<int:class_id>/<int:student_id>', views.delete_student_from_class,
    ...
    path('delete_student_from_homeroom/<int:student_id>', views.delete_student_from_homeroom,
         name='delete_student_from_homeroom'),
    path('view_student_classes/<int:student_id>', views.view_student_classes, name='view_student_classes'),
]
