...
@pytest.mark.parametrize(
    "current_date, expected_trimester_type, expected_meeting_end_of_trimester, "
...
def test_get_current_year_and_trimester_config1(current_date, expected_trimester_type,
    ...
    with freeze_time(current_date):
        ...
        assert trimester.name == expected_trimester_type.name
        assert trimester.trimester_type == expected_trimester_type
...
def test_get_current_year_and_trimester_config2(current_date, expected_trimester_type,
                                                expected_meeting_end_of_trimester,
                                                expected_actual_end_of_trimester, expected_gregorian_school_year,
                                                expected_hebrew_school_year):
    with freeze_time(current_date):
...
def test_get_current_year_and_trimester_no_mock():
    trimester = get_current_trimester()
    assert isinstance(trimester.name, str)
    assert isinstance(trimester.trimester_type, TrimesterType)
